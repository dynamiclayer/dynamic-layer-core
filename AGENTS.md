...
This file defines working rules for AI agents contributing to `dynamiclayer_flutter`.
...
- `dynamiclayer_flutter` is the equivalent Flutter template layer.
...
3. Public API must be exposed only via `lib/dynamiclayer_flutter.dart`.
